...
<div class="wide actions"><button id="retryCheckCPA" type="button" class="ghost" data-i18n="retry.checkCPA">Check &amp; fix CPA retry settings</button></div>
<div class="wide"><p class="setting-help" id="retryCPAStatus"></p></div>
